...
class MarketStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RegisterSeller = channel.unary_unary(
                ...
                response_deserializer=market__pb2.RegistrationResponse.FromString,
                )
        ...
        self.DisplayItems = channel.unary_stream(
                '/Market/DisplayItems',
...
def add_MarketServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RegisterSeller': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=market__pb2.RegistrationResponse.SerializeToString,
            ),
            ...
            'DisplayItems': grpc.unary_stream_rpc_method_handler(
...
class Market(object):
    ...
    def RegisterSeller(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Market/RegisterSeller',
            ...
            market__pb2.RegistrationResponse.FromString,
    ...
    def DisplayItems(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/Market/DisplayItems',
    ...
    def SearchItem(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/Market/SearchItem',
